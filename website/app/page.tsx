...
export default function HomePage() {
  const [mode, setMode] = useState<'studio' | 'showcase'>('studio');
  const [isKeyModalOpen, setIsKeyModalOpen] = useState(false);

  return (
    <main className="relative min-h-screen bg-[#030712] w-full text-slate-100">
      {/* Studio Mode */}
      {mode === 'studio' ? (
        <StudioWorkspace
          currentMode={mode}
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      <a
                        href="https://github.com/Parswanadh/auto-git-pipeline-runs"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-slate-400 hover:text-cyan-400 transition-colors"
                      >
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm">Feb 2026</p>
                </div>
      ...
      {/* Global API Key Modal in Showcase Mode */}
      <ApiKeyModal
